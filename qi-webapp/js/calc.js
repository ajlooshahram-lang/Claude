...
(function (root) {
  ...
  const SUGGEST = {
    problem: [
      // Marine survey
      "Route survey not started - schedule at risk",
      "Seabed sampling results delayed from lab",
      "Hazard assessment incomplete - uncharted area",
      "Geotechnical survey vessel unavailable",
      "Bathymetric data quality below specification",
      "Cable burial assessment not finalised",
      "ROV inspection reveals unexpected seabed conditions",
      // Permitting
      "Cable landing licence application rejected",
      "Environmental permit delayed by regulator",
      "Marine consent hearing postponed",
      "Foreshore licence not yet granted",
      "EIA study requires additional baseline data",
      "Fishing community objection to cable route",
      "Heritage site discovered on planned route",
      "Permit conditions more restrictive than expected",
      // Procurement
      "Cable supply contract negotiation stalled",
      "Repeater delivery behind schedule",
      "Cable ship charter rate exceeds budget",
      "SLTE equipment lead time longer than planned",
      "Spare cable procurement not approved",
      "Subcontractor mobilisation delayed",
      "Power feed equipment delivery slipping",
      "Joint box inventory below minimum stock",
      // Installation
      "Cable lay vessel weather-waiting",
      "Shore-end pull postponed due to tide window",
      "Burial depth target not achieved",
      "Rock placement barge not available",
      "Cable joint failure during lay",
      "Anchor crossing protection incomplete",
      "Horizontal directional drilling rig breakdown",
      "Guard vessel not on station for lay",
      "Cable route deviation required mid-lay",
      // Civil works
      "Landing station construction behind schedule",
      "Power supply connection delayed by utility",
      "Backhaul duct installation blocked by road permit",
      "Beach manhole flooded - requires redesign",
      "Cable tunnel boring machine stuck",
      "Landing station generator commissioning failed",
      // Testing
      "OTDR test shows higher loss than spec",
      "BER test fails at full capacity",
      "System capacity test below design target",
      "System acceptance test criteria not agreed",
      "Wet plant continuity check failed",
      "SLTE integration test errors",
      "End-to-end latency exceeds customer SLA",
      // Risk
      "Typhoon delay - vessel stood down",
      "Permit rejection from coastal authority",
      "Third-party cable damage during installation",
      "Schedule slip on critical path segment",
      "Monsoon season forces lay suspension",
      "Seismic activity near cable route",
      "Ship anchor drag near live cable",
      "Budget overrun exceeds contingency",
      // Quality
      "NCR raised against cable manufacturer",
      "ITP hold point not released by client",
      "Weld inspection failure on riser clamp",
      "Factory acceptance test failed",
      "Cable sheath damage found during loadout",
      "Installation records incomplete at handover",
      "Bend radius violation during cable handling",
      // Contract
      "Variation order submitted for route change",
      "Claim notification issued by contractor",
      "Milestone payment disputed",
      "Liquidated damages clause triggered",
      "Force majeure notice received",
      "Delay event claim from subcontractor",
      "Scope change request pending approval",
      // General project management
      "Delivery targets missed consistently",
      "Defect rate too high - customer complaints",
      "Team overwhelmed - too many parallel tasks",
      "Approval bottleneck adds delay",
      "Cost overrun against budget",
      "Safety near-miss reported",
      "Audit / compliance finding raised",
      "Knowledge lost when staff leave",
      "Handoffs between teams causing delay",
      "As-built documentation incomplete"
    ],
    root: [
      "Handoff delays invisible; no WIP limits",
      "No quality check at source",
      "No WIP limits; everything is priority 1",
      "Wrong routing; unclear decision authority",
      "No documented process; tribal knowledge",
      "No structured cadence in place",
      "Process not standardised",
      "No clear ownership / RACI",
      "Insufficient training or skills",
      "Tooling / system limitation",
      "Unclear or changing requirements",
      "Lack of data to make decisions",
      "Weather window not accounted for in planning",
      "Vendor lead time underestimated",
      "Permit timeline assumed but not confirmed",
      "Insufficient vessel capacity allocated",
      "No contingency plan for route obstruction",
      "Regulatory requirements changed mid-project",
      "Subcontractor resource conflict with other project",
      "Single point of failure in supply chain",
      "Interface between marine and land teams unclear",
      "Survey data not shared with installation team",
      "Risk register not updated after last review",
      "No escalation path defined for critical issues",
      "Inspection criteria not aligned with specification",
      "Communication breakdown between client and contractor",
      "Budget forecast not updated after scope change",
      "Lessons learned from previous project not applied",
      "Testing protocol not agreed before mobilisation",
      "Environmental baseline data outdated"
    ],
    target: [
      "On-time delivery >95% in 8 weeks",
      "Zero defect escapes within 4 weeks",
      "Max 3 active tasks per person",
      "Approval time <4 hours",
      "Reduce cycle time by 30% in 8 weeks",
      "Cut defect rate below 2% in 6 weeks",
      "Reduce cost of poor quality by 25%",
      "Close all critical risks within 2 weeks",
      "Achieve Sigma level >= 4.0",
      "Zero safety incidents this quarter",
      "Cut approval lead time to < 4 hours",
      "Route survey complete within 4 weeks",
      "All landing permits granted before mobilisation",
      "Cable manufacture 100% complete before load-out",
      "Shore-end pull complete in single tide window",
      "Burial depth target achieved on >95% of route",
      "System acceptance test passed first time",
      "All NCRs closed before provisional acceptance",
      "OTDR loss within 0.05 dB/km of specification",
      "Zero cable joints failed during warranty",
      "Vessel utilisation >85% during lay campaign",
      "All variation orders agreed within 14 days",
      "Milestone payments processed within 30 days",
      "Environmental permit secured 3 months before lay",
      "Full as-built documentation within 60 days of RFS",
      "Commissioning complete within 2 weeks of lay",
      "Risk register reviewed weekly with zero overdue actions",
      "Stakeholder objections resolved before public hearing",
      "Cable system ready for service on target date",
